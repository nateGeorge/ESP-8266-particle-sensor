...
xRange2 = np.linspace(0, 500, 10000)
...
xTicks = []
for regime in epaRegimes:
    ax1.axvspan(epaRegimes[regime][0][0], epaRegimes[regime][0][1], alpha=0.5, color =epaRegimes[regime][2])
    ax2.axvspan(epaRegimes[regime][0][0], epaRegimes[regime][0][1], alpha=0.5, color =epaRegimes[regime][2])
    xTicks.append((epaRegimes[regime][0][0] + epaRegimes[regime][0][1])/2)
plt.sca(ax1)
plt.xticks(xTicks, [regime for regime in epaRegimes], rotation=90)
